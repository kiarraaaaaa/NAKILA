                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text("${campus.location}, ${campus.country}"),
                    ],
                  ),
                  ...
                  Wrap(
                    ...
                    children: [
                      Chip(
                        ...
                        label: Text(campus.country),
                      ),

                      Chip(
                        avatar: Icon(Icons.school, size: 16),
                        label: Text(campus.foundedYear),
                      ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        _infoItem("Founded", campus.foundedYear),

                        _infoItem("Ranking", campus.worldRanking),
                      ],
                    ),
                  ),
                  ...
                  StreamBuilder<List<ReviewModel>>(
                    stream: ReviewService().getReviewsByCampus(campus.id),
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) => AddReviewScreen(campus: campus),
                            ),
                          );
                        },
